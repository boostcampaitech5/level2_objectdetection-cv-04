...
class ConvertCOCOToYOLO:
    ...
    def __init__(self, img_folder, json_path, save_path):
...
if __name__ == "__main__":
    ConvertCOCOToYOLO(
        ...
        json_path="../../dataset/indent_train.json",
        save_path="./yolo_dataset/train",
    ).convert()
    ConvertCOCOToYOLO(
        img_folder="../../dataset/train",
        json_path="../../dataset/indent_val.json",
        save_path="./yolo_dataset/val",
    ).convert()
